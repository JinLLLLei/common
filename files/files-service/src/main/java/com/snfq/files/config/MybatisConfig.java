...
@MapperScan({ "com.snfq.customer.mapper", "com.snfq.base.common.mapper" })
public class MybatisConfig {
    ...
    /** * mybatis 映射实体路径     */
    private static String TYPE_ALIAS_PACKAGE = "com.snfq.account.domain";
    @Autowired
